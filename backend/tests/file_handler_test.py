...
class FileHandlerTest(unittest.TestCase):
    ...
    def test_open_new_file_write_existing_directory(self, _dir_exists, mock_open, mock_close):
        self.setup()
        _dir_exists.return_value = True
    ...
    @patch('builtins.open')
    @patch('os.path.exists')
    def test_open_new_file_write_non_existing_directory(self, _dir_exists, mock_open, mock_close, _mkdir):
        self.setup()
        _dir_exists.return_value = False
        mock_close.return_value = True
        mock_open.return_value = "opened"
    ...
    def test_get_write_handle_returns_handle(self, _open_new_file, _mkdir, _dir_exists, _open, _close):
        self.setup()
